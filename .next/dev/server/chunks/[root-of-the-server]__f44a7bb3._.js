...
async function GET() {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$postgres$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT * FROM site_config ORDER BY config_key ASC`);
...
async function PUT(request) {
    try {
        ...
        if (!settings || typeof settings !== 'object') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Se requiere un objeto "settings"'
            }, {
                status: 400
            });
        }
        ...
        for (const [key, value] of Object.entries(settings)){
            // Intentar actualizar
            const updateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$postgres$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE site_config 
         ...
         RETURNING config_key`, [
            ...
            if (updateResult.rowCount && updateResult.rowCount > 0) {
                ...
                // Si no existe, crear
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$postgres$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO site_config (config_key, config_value, config_type)
           VALUES ($1, $2, 'text')`, [
                    key,
                    value
                ]);
...
async function POST(request) {
    try {
        ...
        if (!config_key) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'La clave de configuración es obligatoria'
            }, {
                status: 400
            });
        }
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$postgres$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO site_config (config_key, config_value, config_type, description)
       VALUES ($1, $2, $3, $4)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f44a7bb3._.js.map