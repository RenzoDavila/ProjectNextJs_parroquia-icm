...
"[project]/src/app/api/admin/mass-pricing/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!tipo_misa || tipo_misa.trim() === '') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: 'El tipo de misa es requerido'
            }, {
                status: 400
            });
        }
        ...
        const maxOrderResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$postgres$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT COALESCE(MAX(display_order), 0) + 1 as next_order FROM mass_types');
        const nextOrder = maxOrderResult.rows[0].next_order;
        // Insertar en la base de datos
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$postgres$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO mass_types (tipo_misa, nombre, descripcion, precio, is_active, display_order, created_at, updated_at)
       ...
       RETURNING *`, [
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            message: 'Error al crear el tipo de misa'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__996be8aa._.js.map