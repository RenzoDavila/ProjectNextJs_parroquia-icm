...
"[project]/src/app/api/mass-types/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
      ...
      ORDER BY display_order ASC, nombre ASC`);
        ...
        const massTypes = result.rows.map((row)=>({
                value: row.tipo_misa,
                label: row.nombre,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__15e0b016._.js.map