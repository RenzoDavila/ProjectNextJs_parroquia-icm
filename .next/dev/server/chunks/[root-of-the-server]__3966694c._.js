...
async function GET() {
    try {
        ...
        const checkResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$postgres$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      SELECT column_name, data_type 
      FROM information_schema.columns 
      WHERE table_name = 'mass_reservations' 
      ORDER BY ordinal_position;
    `);
        const columns = checkResult.rows.map((r)=>r.column_name);
        const hasCloudinaryId = columns.includes('comprobante_cloudinary_id');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            hasCloudinaryId,
            message: hasCloudinaryId ? 'La columna comprobante_cloudinary_id ya existe' : 'La columna comprobante_cloudinary_id NO existe - necesita ser agregada manualmente',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3966694c._.js.map