...
const fallbackServices = [
  {
    ...
    description:
      "Consulta los horarios de misas, confesiones y servicios parroquiales.",
    link_url: "/horarios",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      "Conoce nuestros grupos pastorales y actividades comunitarias.",
    link_url: "/servicios",
  },
];
...
const fallbackInterestPages = [
  {
    ...
    title: "Catequesis",
    image_url:
      "https://images.unsplash.com/photo-1544776193-52f10d0f912c?w=400",
    link_url: "#",
  },
  {
    id: 2,
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center backdrop-blur-xl bg-white/20 rounded-3xl p-8 md:p-12 shadow-2xl border border-white/30">
              <SectionHeading
                ...
                subtitle={
                  pageContent?.welcome?.content.subtitle ||
                  "a nuestra parroquia"
                }
              />
              ...
              <div className="relative mt-6 max-w-xs mx-auto">
                <Image
                  src={
                    pageContent?.welcome?.image_url ||
                    "/images/logos/logo-parroquia-new.png"
                  }
                  alt="Parroquia ICM"
                  width={400}
                  height={400}
                ...
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                  <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white">
                    ...
                    <p className="text-blue-100">
                      Realiza tu donación de forma segura
                    </p>
                  </div>
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="backdrop-blur-sm bg-white/5 rounded-3xl p-12 max-w-4xl mx-auto border border-white/10">
              ...
              <p className="text-lg text-gray-200 mb-10 max-w-2xl mx-auto leading-relaxed">
                Revive los mejores momentos de nuestra comunidad parroquial a
                través de nuestra galería fotográfica.
              </p>
              <Link
                href="/galeria"
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative h-64 md:h-80 rounded-lg overflow-hidden shadow-xl">
                <Image
                  src={
                    pageContent?.pastoralJuvenil?.image_url ||
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">
                  {pageContent?.msc?.content.title ||
                    "Provincia Perú - Bolivia"}
                </h2>
                <h3 className="text-xl text-primary mb-4">
                  {pageContent?.msc?.content.subtitle ||
                ...
                <Button
                  href={
                    pageContent?.msc?.content.buttonUrl ||
                    EXTERNAL_LINKS.peruBolivia.website
                  }
                  variant="primary"
                  external
                >
                  {pageContent?.msc?.content.buttonText ||
                    "Conoce más sobre los MSC"}
                </Button>
              </div>
            </div>
          </div>
