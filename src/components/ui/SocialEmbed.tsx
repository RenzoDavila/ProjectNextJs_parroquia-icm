...
function IframePlaceholder({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center h-full min-h-[200px] bg-gradient-to-br ${gradient} animate-pulse`}
    >
  ...
  return (
    <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="rounded-xl overflow-hidden shadow-lg bg-white">
        ...
        {isVisible ? (
          <iframe
            src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FDel-Inmaculado-Coraz%C3%B3n-de-Mar%C3%ADa-Miraflores-AQP-104673071260189%2F&tabs=timeline&width=500&height=450&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=false&appId=118909448694662"
            width="100%"
            height="450"
