...
export default function ContactForm({ siteConfig }: ContactFormProps) {
  ...
  return (
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#002F57] mb-2">Ubicación</h2>
          <p className="text-gray-600 mb-8">Encuéntranos fácilmente</p>
